% diagnostic_script_4.m
% exercises the diagnostic functions to create an artificial tank
% This fourth version uses the breath dependent control and a breath
...
% determines the placement of the center of the gaussian.  .5 has the
...
% equal to 20 percent of the distance between the peaks
breathing_off_rate = 0.0; % keep 0 and control off_rate with off_rate variable instead
...
addpath('/Users/sshort/Desktop/DLPCode/Analyses/20140616/Static20140616')
%cd ../ORNstim
...
% breath angle
if 0
    breath_cycle_theta_time = 0:1/fs:(breath_period+1/fs);%0:1/fs:(breath_period+1/fs); % adding 1/fs insures
...
[ poisson_rate ] = 1000+stimulus_implied_poisson_rate(total_time, dt, on_rate, off_rate, S_ON, SOFF );
